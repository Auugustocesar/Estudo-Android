...
import com.augusto.atmconsultoria.fragment.ClientesFragment;
import com.augusto.atmconsultoria.fragment.PrincipalFragment;
import com.augusto.atmconsultoria.fragment.ServicosFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public void enviarEmail() {
        ...
        email.putExtra(Intent.EXTRA_TEXT, "Corpo de email");

        email.setType("message/rfc822");

        startActivity(Intent.createChooser(email, "Escolha o aoo de e-mail"));
    }
}
